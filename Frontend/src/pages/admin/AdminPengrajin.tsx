...
const handleAddMasterSkill = async () => {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-3 p-4 rounded-2xl border border-border bg-background shadow-sm md:sticky md:top-0 z-10 mt-0">
